import os
import numpy as np
from src.simulator import simulate, simulate_, make_step_fn, make_step_fn_fd
...
def main():
    ...
    np.save(os.path.join(stored_data_directory, 'states_reverse.npy'), states)
    np.save(os.path.join(stored_data_directory, 'jacobians_reverse.npy'), jacobians)
